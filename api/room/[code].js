...
import { buildRoom, publicRoom, openEnvelope, judge, nextTeam, finish } from '../../lib/game.js';
...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST') {
      ...
      else if (action === 'reset') { room = buildRoom(game); room.started = true; event = { type: 'reset' }; }
